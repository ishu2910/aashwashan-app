        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <img 
                src="https://customer-assets.emergentagent.com/job_0ea42f9a-ec24-4349-8b7e-7c4b2ee7febf/artifacts/utz6qiri_Untitled%20design.png" 
                alt="Aashwashan Logo" 
            ...
            <div className="flex space-x-3">
              ...
              <a href="https://x.com/Aashwashan_care" target="_blank" rel="noopener noreferrer" 
                 className="w-10 h-10 bg-white/10 hover:bg-gray-800 rounded-full flex items-center justify-center transition-all duration-300">
