...
export const team = [
  {
    ...
    bio: "Compassionate psychologist with a Master's degree and extensive experience in counseling and mental health support. Member of the American Psychological Association (APA). Provides holistic care through assessments, behavioral interventions, and evidence-based counseling.",
    education: "M.A. in Psychology, National PG College Lucknow",
    credentials: "Member, American Psychological Association (APA)",
    awards: ["Fellowship of IMHRC", "Best Leader Recognition NSS (2022-2025)"]
  },
  {
    id: 2,
    name: "Sonali Mishra",
