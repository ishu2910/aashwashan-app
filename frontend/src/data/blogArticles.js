...
export const mentalHealthArticles = [
  // Latest Articles - April 2026
  {
    id: 51,
    title: "WHO Report: India Sees 22% Drop in Untreated Depression Cases Since 2023",
    excerpt: "The World Health Organization's latest Global Mental Health Report highlights India's progress in expanding access to affordable therapy, citing the Tele MANAS helpline and district mental health programs as key drivers of the improvement.",
  ...
  {
    id: 52,
    title: "Bengaluru Startup Launches India's First AI-Powered Therapy Matching Platform",
    excerpt: "A Bengaluru-based healthtech startup has launched an AI-driven platform that matches patients with therapists based on their specific needs, language preferences, and therapy style — reducing dropout rates by 45% in early trials.",
    category: "Trends",
    date: "April 10, 2026",
    readTime: "5 min",
  ...
  {
    id: 53,
    title: "Supreme Court Asks Centre to Frame National Mental Health Policy for Students",
    excerpt: "The Supreme Court of India has directed the Ministry of Health to draft a comprehensive mental health policy for students across schools and universities, following a PIL highlighting rising suicide rates among young Indians.",
...
export const newsCategories = [
  { name: "All Updates", count: 53 },
  { name: "Research & Studies", count: 18 },
  { name: "Policy & Budget", count: 11 },
  { name: "Healthcare News", count: 13 },
